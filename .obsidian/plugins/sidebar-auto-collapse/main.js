...
var y = (s, e) => {
    for (var t in e) g(s, t, { get: e[t], enumerable: !0 });
  },
  E = (s, e, t, i) => {
...
var C = (s) => E(g({}, "__esModule", { value: !0 }), s);
var L = {};
y(L, { default: () => d });
module.exports = C(L);
var h = require("obsidian");
var a = require("obsidian"),
  m = "sbc-grouped-settings-styles",
  T = [
...
function R() {
  ...
  ((s.id = m), (s.textContent = T), document.head.appendChild(s));
}
function V(s) {
  let e = Array.from(s.children),
    t = null;
  for (let i of e) {
    let n = i.classList.contains("setting-item-heading");
    i.classList.contains("setting-item") && !n
      ? (t ||
...
var w = {
    enabled: !0,
    enableInFullScreen: !0,
    timeoutSeconds: 5,
    resetOnActivity: !0,
    showVaultSwitcher: !0,
    showPluginSettings: !0,
    showObsidianSettings: !0,
    closeCurrentVaultOnSwitch: !1,
  },
  p = class extends a.PluginSettingTab {
    constructor(e, t) {
    ...
    display() {
      ...
      (e.empty(),
        e.addClass("sbc-grouped"),
        R(),
        new a.Setting(e).setName("Sidebar behaviour").setHeading(),
        new a.Setting(e)
          ...
          .addToggle((t) =>
            t.setValue(this.plugin.settings.enabled).onChange(async (i) => {
              ((this.plugin.settings.enabled = i),
        ...
        new a.Setting(e)
          ...
          .addToggle((t) =>
            t
              ...
              .onChange(async (i) => {
                ((this.plugin.settings.enableInFullScreen = i),
                  await this.plugin.saveSettings());
              })
          ),
        new a.Setting(e)
          ...
          .setDesc(
            "Number of seconds of inactivity before the sidebar collapses."
          )
          .addText((t) =>
            t
              .setPlaceholder("5")
        ...
        new a.Setting(e)
          ...
          .addToggle((t) =>
            t
              ...
              .onChange(async (i) => {
                ((this.plugin.settings.resetOnActivity = i),
                  await this.plugin.saveSettings());
              })
          ),
        new a.Setting(e).setName("Vault switcher").setHeading(),
        new a.Setting(e)
          ...
          .addToggle((t) =>
            t
              ...
              .onChange(async (i) => {
                ((this.plugin.settings.closeCurrentVaultOnSwitch = i),
                  await this.plugin.saveSettings());
              })
          ),
        new a.Setting(e).setName("Ribbon buttons").setHeading(),
        new a.Setting(e)
          ...
          .addToggle((t) =>
            t
              ...
              .onChange(async (i) => {
                ((this.plugin.settings.showVaultSwitcher = i),
                  await this.plugin.saveSettings(),
        ...
        new a.Setting(e)
          ...
          .addToggle((t) =>
            t
              ...
              .onChange(async (i) => {
                ((this.plugin.settings.showPluginSettings = i),
                  await this.plugin.saveSettings(),
                  this.plugin.applyRibbonVisibility());
              })
          ),
        new a.Setting(e)
          ...
          .addToggle((t) =>
            t
              ...
              .onChange(async (i) => {
                ((this.plugin.settings.showObsidianSettings = i),
                  await this.plugin.saveSettings(),
                  this.plugin.applyRibbonVisibility());
              })
          ),
...
function O() {
  ...
  return t === "darwin"
    ...
    : t === "win32"
      ? e.join(process.env.APPDATA || "", "obsidian", "obsidian.json")
      : e.join(s.homedir(), ".config", "obsidian", "obsidian.json");
}
function A(s) {
  try {
    let e = require("fs"),
      t = require("path"),
      i = e.readFileSync(O(), "utf8"),
      o = JSON.parse(i).vaults || {},
      u = (l) => l.replace(/\/$/, ""),
      c = u(s);
    return Object.entries(o)
      .map(([l, r]) => ({
        id: l,
        name: t.basename(r.path),
        path: r.path,
        isCurrent: u(r.path) === c,
      }))
...
function I(s) {
  let e = `obsidian://open?vault=${encodeURIComponent(s)}`;
  try {
...
function x() {
  var s;
  try {
    let t = require("electron").remote;
    if (t != null && t.getCurrentWindow) {
      t.getCurrentWindow().close();
      return;
    }
  } catch (e) {}
  try {
    let e =
      (s = window.require) == null
        ? void 0
        : s.call(window, "@electron/remote");
    if (e != null && e.getCurrentWindow) {
      e.getCurrentWindow().close();
      return;
    }
  } catch (e) {}
  window.close();
}
var b = class extends h.FuzzySuggestModal {
    constructor(t, i, n, o) {
      super(t);
      this.vaults = i;
      this.onChoose = n;
      this.setPlaceholder(o);
    }
    getItems() {
      return this.vaults;
    }
    getItemText(t) {
      return t.isCurrent ? `${t.name} (current)` : t.name;
    }
    onChooseItem(t) {
      t.isCurrent || this.onChoose(t);
    }
  },
  d = class extends h.Plugin {
    constructor() {
      super(...arguments);
      this.vaultRibbonEl = null;
      this.pluginSettingsRibbonEl = null;
      this.obsidianSettingsRibbonEl = null;
      ...
      (await this.loadSettings(),
        ...
        (this.pluginSettingsRibbonEl = this.addRibbonIcon(
          ...
          () => {
            (this.app.setting.open(),
              this.app.setting.openTabById("sidebar-auto-collapse"));
          }
        )),
        ...
        this.app.workspace.onLayoutReady(() => {
          ((this.wasCollapsed = this.app.workspace.leftSplit.collapsed),
            this.setupObserver());
          let t =
            this.app.workspace.containerEl.querySelector(".mod-left-split");
          (t &&
            (this.registerDomEvent(t, "mousemove", () => {
              this.settings.enabled &&
                this.settings.resetOnActivity &&
                this.collapseTimer !== null &&
                this.startTimer();
            }),
            this.registerDomEvent(t, "click", () => {
              this.settings.enabled &&
                this.settings.resetOnActivity &&
                this.collapseTimer !== null &&
                this.startTimer();
            })),
            !this.wasCollapsed && this.settings.enabled && this.startTimer());
        }));
    }
    repositionRibbonIcons() {
      ...
      let t =
        (o =
          (n = (i = this.app.workspace) == null ? void 0 : i.containerEl) ==
          null
            ? void 0
            : n.querySelector) == null
          ? void 0
          : o.call(n, ".side-dock-actions");
      return t
        ? (this.vaultRibbonEl && t.appendChild(this.vaultRibbonEl),
          this.pluginSettingsRibbonEl &&
            t.appendChild(this.pluginSettingsRibbonEl),
          this.obsidianSettingsRibbonEl &&
            t.appendChild(this.obsidianSettingsRibbonEl),
          !0)
        : !1;
    }
    ...
    openVaultSwitcher() {
      ...
      let t = this.app.vault.adapter,
        i =
          t.basePath ||
          ((c = t.getBasePath) == null ? void 0 : c.call(t)) ||
          "",
        n = A(i);
      if (n.length === 0) {
        this.app.commands.executeCommandById("app:switch-vault");
        return;
      }
      let o = this.settings.closeCurrentVaultOnSwitch,
        u = o
      ...
      new b(
        ...
        n,
        (l) => {
          (I(l.name), o && window.setTimeout(() => x(), 400));
        },
        u
      ).open();
    }
      ...
      ((this.observer = new MutationObserver(() => {
        ...
        if (
          ...
          (!!((n = document.fullscreenElement) != null
            ...
            !this.settings.enableInFullScreen)
        )
          return;
        let i = this.app.workspace.leftSplit.collapsed;
        i !== this.wasCollapsed &&
          (i ? this.clearTimer() : this.startTimer(), (this.wasCollapsed = i));
      })),
    ...
    onunload() {
      var t;
      (this.clearTimer(), (t = this.observer) == null || t.disconnect());
    }
    startTimer() {
      (this.clearTimer(),
    ...
    clearTimer() {
      this.collapseTimer !== null &&
        (window.clearTimeout(this.collapseTimer), (this.collapseTimer = null));
    }
    async loadSettings() {
