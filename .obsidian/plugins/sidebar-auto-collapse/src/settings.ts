...
export class AutoCollapseSidebarSettingTab extends PluginSettingTab {
    ...
    display(): void {
        ...
        new Setting(containerEl)
            ...
            .setDesc('Automatically collapse the left sidebar after a period of inactivity.')
        ...
        new Setting(containerEl)
            ...
            .setDesc('Auto-collapse the sidebar when Obsidian is in full screen mode.')
            .addToggle(toggle => toggle
        ...
        new Setting(containerEl)
            ...
            .setDesc('Restart the countdown when the mouse moves or clicks within the sidebar.')
            .addToggle(toggle => toggle
        ...
        new Setting(containerEl)
            ...
            .setDesc('When enabled, closes the current window after opening the selected vault. When disabled, the current vault stays open and the new vault opens in a separate window.')
            .addToggle(toggle => toggle
