...
export class SettingsHighlighterSettingTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        "Border color for highlighted items. Reset to use the accent color."
      )
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        "Extends solid outline highlighting to all settings pages, not just individual plugin pages."
      )
      .addToggle((toggle) =>
        toggle
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        "Add a chevron to Core and Community plugin section headings to manually collapse or expand them."
      )
      .addToggle((toggle) =>
        toggle
    ...
    if (this.plugin.settings.collapsibleSections) {
      new Setting(containerEl)
        ...
        .setDesc(
          "When viewing a core plugin's settings, collapse the Community plugins section, and vice versa."
        )
        .addToggle((toggle) =>
          toggle
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        "Show a ribbon button that opens the Core plugins settings page."
      )
      .addToggle((toggle) =>
        toggle
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        "Show a ribbon button that opens the Community plugins settings page."
      )
      .addToggle((toggle) =>
        toggle
